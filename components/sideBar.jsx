    ...
    return (
        <div className='bg-gradient-to-br from-[#060b27] from-94% to-[#1A1F3700]  text-white h-screen w-[264px] pl-6 p-6 flex justify-between flex-col'>
            ...
            <ul className='flex flex-col space-y-2 py-4 '>
                <Link href={'/dashboard'} className='flex gap-2 items-center bg-[#1a1f37] rounded-2xl p-2 cursor-pointer text-[14px] font-[400]'><span className='p-1 bg-[#0075FF] rounded-[20px]'><FaHome className=' w-[15px] h-[15px] text-white  flex items-center justify-center' /></span>Dashboard</Link>
                <Link href={'/dashboard/tables'} className='flex gap-2 items-center hover:bg-[#1a1f37] rounded-2xl p-2 cursor-pointer text-[14px] font-[400]'><span className='p-1 bg-[#0075FF] rounded-[20px]'><MdBarChart className=' w-[15px] h-[15px] text-white  flex items-center justify-center' /></span>Tables</Link>
                <li className='flex gap-2 items-center hover:bg-[#1a1f37] rounded-2xl p-2 cursor-pointer text-[14px] font-[400]'><span className='p-1 bg-[#0075FF] rounded-[20px]'><FaRegCreditCard className=' w-[15px] h-[15px] text-white  flex items-center justify-center' /></span>Billing</li>
